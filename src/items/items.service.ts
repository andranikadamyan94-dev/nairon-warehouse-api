...
export class ItemsService {
  ...
  async create(dto: CreateItemDto) {
    // Codes are autogenerated from the row id (RES-000042) — derived from the
    // autoincrement, so uniqueness is free and race-proof. Whatever the client
    // sends is ignored; the field stayed on the DTO only for compatibility.
